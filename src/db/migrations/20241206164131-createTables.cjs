...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('orcamentos', {
      ...
      forma_pagamento: { type: Sequelize.STRING, allowNull: true },
      validade: { type: Sequelize.DATE, allowNull: true },
      status: { type: Sequelize.ENUM('Aguardando pagamento', 'Pago'), allowNull: true, defaultValue: 'Aguardando pagamento' },
    ...
    await queryInterface.createTable('orcamento_procedimentos', {
      ...
      nome_procedimento: { type: Sequelize.STRING, allowNull: true },
      obs_procedimento: { type: Sequelize.STRING, allowNull: true },
      valor_procedimento: { type: Sequelize.DECIMAL(10, 2), allowNull: true },
      status_retorno: { type: Sequelize.ENUM('Finalizado', 'Aguardando procedimento', 'Retorno'), allowNull: true, defaultValue: 'Aguardando procedimento' },
      num_retorno: { type: Sequelize.INTEGER, allowNull: true, defaultValue: 0 },
